...
3. GitHub Pages is the default deployment target at
   <https://free-llm-models.custats.com/>. Configure the repository Pages
   source as **GitHub Actions**; `.github/workflows/deploy-pages.yml` builds and
   uploads `web/dist` with the project base path.

   Production builds set `VITE_BASE_PATH=/` and
   `VITE_SITE_URL=https://free-llm-models.custats.com`. When
...
| -------- | ------------- | ---------------------- |
| `VITE_BASE_PATH` | `/` | `/` |
| `VITE_SITE_URL` | `https://free-llm-models.custats.com` | `https://free-llm-models.custats.com` |
