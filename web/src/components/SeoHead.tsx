...
export function SeoHead({ metadata, structuredData }: { metadata: SeoMetadata; structuredData?: StructuredData }) {
  useEffect(() => {
    ...
    setMeta('property', 'og:image', metadata.image ?? 'https://free-llm-models.vercel.app/og-image.svg');
    setMeta('property', 'og:site_name', 'Free LLM Models');
    setMeta('name', 'twitter:card', 'summary_large_image');
    setMeta('name', 'twitter:title', metadata.title);
    setMeta('name', 'twitter:description', metadata.description);
    setMeta('name', 'twitter:image', metadata.image ?? 'https://free-llm-models.vercel.app/og-image.svg');
