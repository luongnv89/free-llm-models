            ...
            <div className="space-y-3">
              <FAQItem id="what-are-free-models" question="What are OpenRouter free models?" defaultOpen={!targetId} targetId={targetId}>
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  Free models include offerings from Google (Gemma), Meta (Llama), Mistral, DeepSeek, and more.
                </p>
              </FAQItem>
              ...
              <FAQItem id="get-api-key" question="How do I get an API key?" targetId={targetId}>
                ...
                <WarningBox>
                  <strong>Security Warning:</strong> Never share your API key publicly or commit it to version control.
              ...
              <FAQItem id="first-api-call" question="How do I make my first API call?" targetId={targetId}>
                ...
                <StepsContainer>
                  ...
                  <Step
                    ...
                    description={
                      <span>
                        Pick a free model like <code className="bg-muted px-1.5 py-0.5 rounded text-xs">google/gemma-3-27b-it:free</code>
                      </span>
                    }
                  />
                  <Step
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <FAQItem id="rate-limits" question="What are the rate limits for free models?" targetId={targetId}>
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  For production workloads or higher limits, consider using paid models or adding credits to your account.
                </p>
              </FAQItem>
                  ...
                  <div className="flex gap-3 p-3 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Some providers log prompts and outputs for model improvement. Don't send sensitive data.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Each model has its own acceptable use policy. Check the documentation for specifics.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-lg border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Most free models allow commercial use, but verify the license for your specific use case.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3 p-3 rounded-lg border border-border">
              ...
              <FAQItem id="expiration-date" question="Why do some models have an expiration date?" targetId={targetId}>
                ...
                <div className="grid gap-2">
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    <span className="text-sm">The model may no longer be available for free</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    <div className="w-6 h-6 rounded-full bg-blue-500/10 flex items-center justify-center">
                      <RefreshCw className="w-3 h-3 text-blue-500" />
                    </div>
                    <span className="text-sm">It might be replaced with a newer version</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                    <div className="w-6 h-6 rounded-full bg-amber-500/10 flex items-center justify-center">
                      <span className="text-amber-500 text-xs">$</span>
                    </div>
                    <span className="text-sm">Pricing may change to a paid model</span>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mt-4">
                  Check the model details page for expiration information and plan accordingly.
                </p>
              </FAQItem>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-3">
              <FAQItem id="claude-code" question="How do I use OpenRouter with Claude Code?" targetId={targetId}>
                ...
                <h4 className="font-medium mt-6 mb-3">Method 1: Shell Profile (Recommended)</h4>
                <StepsContainer>
                  <Step
                    number={1}
                    ...
                    description={
                      <span>
                        Edit <code className="bg-muted px-1.5 py-0.5 rounded text-xs">~/.bashrc</code>,{' '}
                        <code className="bg-muted px-1.5 py-0.5 rounded text-xs">~/.zshrc</code>, or your shell's config file
                      </span>
                    }
                  />
                  <Step
...
export ANTHROPIC_API_KEY=""`}
                ...
                <h4 className="font-medium mt-6 mb-3">Method 2: Project Settings</h4>
                <p className="text-sm text-muted-foreground mb-3">
                  Create a <code className="bg-muted px-1.5 py-0.5 rounded text-xs">.claude/settings.local.json</code> file in your project root:
                </p>
                <CodeBlock
                  language="json"
  ...
  "env": {
    ...
    "ANTHROPIC_API_KEY": ""
                ...
                <WarningBox>
                  <strong>Important:</strong> The <code className="bg-amber-500/20 px-1 rounded">ANTHROPIC_API_KEY</code> must be explicitly set to empty to prevent conflicts with the OpenRouter configuration.
                </WarningBox>
                ...
                <StepsContainer>
                  <Step
                    ...
                    description={
                      <code className="bg-muted px-1.5 py-0.5 rounded text-xs">cd /path/to/your/project && claude</code>
                    }
                  />
                  <StepLast
            ...
            <div className="space-y-3">
              <FAQItem id="store-api-key" question="How should I store my API key?" targetId={targetId}>
                ...
                <div className="grid gap-3 sm:grid-cols-2 mb-4">
                  ...
                  />
                  <InfoCard
                    icon={<ShieldAlert className="h-5 w-5 text-[var(--highlight)]" />}
