...
const { collectProvider, writeProviderOutputs } = require('./emit');
 ...
 *   files?: string[], index?: Object, pruned?: string[], legacyPath?: string}>}
 */
...
function applyHistoryMerges({ results, outputDir, io, warn }) {
  for (const result of results) {
    ...
    result.history = { archivedModels, newModelIds };
  }
}
