...
- `lib/providers/*.js` — one adapter per provider (openrouter, groq, google, cerebras, huggingface, nvidia-nim) plus shared schema/emit helpers.
...
- Don't hand-edit the generated PNG/ICO brand assets in web/public/; edit the SVG sources and re-run render-brand-assets.mjs.
